...
1. `THE SPECIFIED UPDATE REQUIRES TP LIBS 2.0.7+ VERSION.`

2. `(!) BEFORE UPDATING, ALL CONTENTS WILL BE LOST, MAKE SURE TO LET YOUR PLAYERS TAKE THEIR ITEMS FIRST`

3. `TO UPDATE THE SCRIPT, YOU WILL HAVE TO EMPTY (DELETE / CLEAR) THE tp_motels DATABASE TABLE WHILE SERVER IS OFFLINE`
